          ...
          <div className="flex gap-4 max-w-2xl w-full">
            <div className="bg-gray-900/90 p-8 rounded-lg border-2 border-red-600 shadow-lg flex-1">
              ...
              <div className="space-y-6">
                ...
                <button
                    className="px-6 py-2 bg-red-700 hover:bg-red-600 text-white rounded border-2 border-red-600 font-mono"
                  >
                    Login
                  </button>
                ...
                <div className="flex flex-col gap-4">
                  <button
                    className="px-6 py-2 bg-red-700 hover:bg-red-600 text-white rounded border-2 border-red-600 font-mono"
                    onClick={() => handleButtonClick('MetaMask Wallet')}
                  >
                    MetaMask Wallet
                  </button>
                  <button
                    className="px-6 py-2 bg-red-700 hover:bg-red-600 text-white rounded border-2 border-red-600 font-mono"
                    onClick={() => handleButtonClick('CoinBase Wallet')}
                  >
                    CoinBase Wallet
                  </button>
                  <button
                    className="px-6 py-2 bg-red-700 hover:bg-red-600 text-white rounded border-2 border-red-600 font-mono"
                    onClick={() => handleButtonClick('Rainbow Wallet')}
                  >
                    Rainbow Wallet
                  </button>
                  <AuthButton />
